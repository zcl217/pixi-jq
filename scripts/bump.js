class Bump {
    ...
    */
    ...
    rectangleCollision(
      r1, r2, bounce = false, global = true, r1State = undefined
    ) {
    ...
    */
    ...
    hitTestRectangle(r1, r2, global = false) {
      ...
      if (global) {
        ...
        vx = (r1.x + Math.abs(r1.halfWidth) - r1.xAnchorOffset) - (r2.x + Math.abs(r2.halfWidth) - r2.xAnchorOffset);
        vy = (r1.y + Math.abs(r1.halfHeight) - r1.yAnchorOffset + 1) - (r2.y + Math.abs(r2.halfHeight) - r2.yAnchorOffset);
      }
